...
int main() {
	int sock_FD;
	char buffer[MAXLINE];
	char hello[] ="Message from Client 1... I am Active---😊️";
	...
	char cr[1024];
		...
		ret="(Client 1)==> Card has been varified!";
		}
		if(buffer[0]=='2')
		{
	
		ret="(Client 1)==> Pin has been varified!";
		}
		if(buffer[0]=='3')
		{int a,b;
		char *pk;
		...
		ret="(Client 1)==> Deposit Successful!...Your new account balance is: "+to_string(b);
		}
